...
from eva.executor.set_constraint_executor import SetConstraintExecutor
...
class PlanExecutor:
    ...
    def _build_execution_tree(self, plan: AbstractPlan) -> AbstractExecutor:
        ...
        elif plan_opr_type == PlanOprType.SET_CONSTRAINT:
            executor_node = SetConstraintExecutor(node=plan)
